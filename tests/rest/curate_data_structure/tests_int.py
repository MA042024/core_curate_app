...
from tests.components.curate_data_structure.fixtures.fixtures import DataStructureFixtures
from core_main_app.utils.tests_tools.MockUser import create_mock_user
from core_main_app.utils.tests_tools.RequestMock import RequestMock
from core_curate_app.rest.curate_data_structure import views as data_structure_rest_views
...
class TestDataStructureListAdmin(MongoIntegrationBaseTestCase):
    ...
    def test_get_returns_all_user_data_structure(self):
        # Act
        response = RequestMock.do_request_get(data_structure_rest_views.AdminCurateDataStructureList.as_view(),
                                              self.user)
    ...
    def test_post_returns_data_structure(self):
        ...
        # Act
        response = RequestMock.do_request_post(data_structure_rest_views.AdminCurateDataStructureList.as_view(),
