...
urlpatterns = [
    ...
    re_path(r'^start_curate$', user_ajax.start_curate,
            name='core_curate_start'),
    re_path(r'^enter-data/(?P<curate_data_structure_id>\w+)$', user_views.EnterDataView.as_view(),
    ...
    re_path(r'^enter-data/(?P<curate_data_structure_id>\w+)/(?P<reload_unsaved_changes>\w+)$',
            ...
            name='core_curate_enter_data'),
    re_path(r'^view-data/(?P<curate_data_structure_id>\w+)$', user_views.ViewDataView.as_view(),
